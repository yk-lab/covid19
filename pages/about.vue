<template>
  <div class="About">
    ...
    <TextCard>
      当サイトは新型コロナウイルス感染症（COVID-19）に関する最新情報を提供するために、<a href="https://github.com/tokyo-metropolitan-gov/covid19">東京都公式 新型コロナウイルス対策サイト</a>をフォークしたものです。<br />
      <br />
    ...
    <TextCard title="免責事項">
      当サイトに掲載されている情報については、北海道または札幌市によって公開されたデータですが、北海道および札幌市、当サイトの開発者・関係者は利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。<br />
      <br />
